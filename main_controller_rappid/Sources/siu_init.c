...
void siu_portA_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[0].R = 0x0201;
             /* User Assigned Signal Name : buzzer  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[2].R = 0x0201;
             /* User Assigned Signal Name : shutdown_out  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[4].R = 0x0201;
             /* User Assigned Signal Name : pump_en  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[6].R = 0x0601;
             /* User Assigned Signal Name : pump_pwm  */
             /*	Selected Function : eMIOS_0_6 O          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
void siu_portF_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[80].R = 0x2001;
             /* User Assigned Signal Name : torque0  */
             /*	Selected Function : ADC0_ANS8          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[82].R = 0x2001;
             /* User Assigned Signal Name : torque1  */
             /*	Selected Function : ADC0_ANS10          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[84].R = 0x2001;
             /* User Assigned Signal Name : brake0  */
             /*	Selected Function : ADC0_ANS12          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[86].R = 0x2001;
             /* User Assigned Signal Name : brake1  */
             /*	Selected Function : ADC0_ANS14          */
             /*	Output Buffers : Disabled         */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
/*-----------------------------------------------------------*/
               SIU.PSMI[7].R = 0x02;
                /*Function Pad Selected DSPI1_SSCK :- PCR114*/
...
/*-----------------------------------------------------------*/
               SIU.PSMI[9].R = 0x03;
                /*Function Pad Selected DSPI1_SS :- PCR115*/
