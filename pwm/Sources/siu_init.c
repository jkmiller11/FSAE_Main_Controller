...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[0]  eMIOS_0_0_CLKOUT_PA0 (G4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[0].R = 0x0601;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[1]  eMIOS_0_1_NMI_PA1 (F3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[1].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[2]  eMIOS_0_2_PA2 (F2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[2].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[3]  eMIOS_0_3_PA3 (K15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[3].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[4]  eMIOS_0_4_PA4 (N6) */
    /* ----------------------------------------------------------- */
       SIU.PCR[4].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[5]  eMIOS_0_5_PA5 (C11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[5].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[6]  eMIOS_0_6_PA6 (D11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[6].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[7]  eMIOS_0_7_TXD_3_PA7 (D16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[7].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[8]  eMIOS_0_8_RXD_3_PA8 (C16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[8].R = 0x0103;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[9]  eMIOS_0_9_PA9 (C15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[9].R = 0x0102;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[10]  eMIOS_0_10_SDA_0_PA10 (B16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[10].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[11]  eMIOS_0_11_SCL_0_PA11 (B15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[11].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[12]  SIN_0_PA12 (T7) */
    /* ----------------------------------------------------------- */
       SIU.PCR[12].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[13]  SOUT_0_PA13 (R7) */
    /* ----------------------------------------------------------- */
       SIU.PCR[13].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[14]  SCK_0_PCS_0.0_PA14 (P6) */
    /* ----------------------------------------------------------- */
       SIU.PCR[14].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[15]  PCS_0.0_SCK_0_PA15 (R6) */
    /* ----------------------------------------------------------- */
       SIU.PCR[15].R = 0x0001;
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[16]  CNTX_0_PB0 (N3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[16].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[17]  CNRX_0_PB1 (N1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[17].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[18]  TXD_0_SDA_0_PB2 (B2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[18].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[19]  RXD_0_SCL_0_PB3 (C3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[19].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[20]  ADC0_ANP0_PB4 (T16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[20].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[21]  ADC0_ANP1_PB5 (R16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[21].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[22]  ADC0_ANP2_PB6 (P15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[22].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[23]  ADC0_ANP3_PB7 (P16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[23].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[24]  XTAL32_ADC0_ANS0_PB8 (R9) */
    /* ----------------------------------------------------------- */
       SIU.PCR[24].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[25]  EXTAL32_ADC0_ANS1_PB9 (T9) */
    /* ----------------------------------------------------------- */
       SIU.PCR[25].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[26]  ADC0_ANS2_PB10 (P9) */
    /* ----------------------------------------------------------- */
       SIU.PCR[26].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[27]  eMIOS_0_3_PCS_0.0_ADC0_ANS3_PB11 (N13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[27].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[28]  eMIOS_0_4_PCS_0.1_ADC0_ANX0_PB12 (M16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[28].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[29]  eMIOS_0_5_PCS_0.2_ADC0_ANX1_PB13 (M13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[29].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[30]  eMIOS_0_6_PCS_0.3_ADC0_ANX2_PB14 (L16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[30].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[31]  eMIOS_0_7_PCS_0.4_ADC0_ANX3_PB15 (L13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[31].R = 0x0001;
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[32]  TDI_PC0 (A8) */
    /* ----------------------------------------------------------- */
       SIU.PCR[32].R = 0x4903;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[33]  TDO_PC1 (C9) */
    /* ----------------------------------------------------------- */
       SIU.PCR[33].R = 0x4A01;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[34]  SCK_1_CNTX_4_PC2 (A11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[34].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[35]  PCS_1.0_ADC_MA0_CNRX_4_CNRX_1_PC3 (B11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[35].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[36]  SIN_1_CNRX_3_PC4 (B7) */
    /* ----------------------------------------------------------- */
       SIU.PCR[36].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[37]  SOUT_1_CNTX_3_PC5 (A7) */
    /* ----------------------------------------------------------- */
       SIU.PCR[37].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[38]  TXD_1_PC6 (R2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[38].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[39]  RXD_1_PC7 (P3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[39].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[40]  TXD_2_PC8 (A1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[40].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[41]  RXD_2_PC9 (B1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[41].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[42]  CNTX_1_CNTX_4_ADC_MA1_PC10 (M3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[42].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[43]  CNRX_1_CNRX_4_PC11 (M4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[43].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[44]  eMIOS_0_12_SIN_2_PC12 (B4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[44].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[45]  eMIOS_0_13_SOUT_2_PC13 (A2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[45].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[46]  eMIOS_0_14_SCK_2_PC14 (C1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[46].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[47]  eMIOS_0_15_PCS_2.0_PC15 (D3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[47].R = 0x0001;
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[48]  ADC0_ANP4_PD0 (P12) */
    /* ----------------------------------------------------------- */
       SIU.PCR[48].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[49]  ADC0_ANP5_PD1 (T12) */
    /* ----------------------------------------------------------- */
       SIU.PCR[49].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[50]  ADC0_ANP6_PD2 (R12) */
    /* ----------------------------------------------------------- */
       SIU.PCR[50].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[51]  ADC0_ANP7_PD3 (P13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[51].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[52]  ADC0_ANP8_PD4 (R13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[52].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[53]  ADC0_ANP9_PD5 (T13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[53].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[54]  ADC0_ANP10_PD6 (T14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[54].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[55]  ADC0_ANP11_PD7 (R14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[55].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[56]  ADC0_ANP12_PD8 (T15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[56].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[57]  ADC0_ANP13_PD9 (N15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[57].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[58]  ADC0_ANP14_PD10 (N14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[58].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[59]  ADC0_ANP15_PD11 (N16) */
    /* ----------------------------------------------------------- */
       SIU.PCR[59].R = 0x0000;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[60]  PCS_0.5_eMIOS_0_24_ADC0_ANS4_PD12 (M15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[60].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[61]  PCS_1.0_eMIOS_0_25_ADC0_ANS5_PD13 (M14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[61].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[62]  PCS_1.1_eMIOS_0_26_ADC0_ANS6_PD14 (L15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[62].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[63]  PCS_1.2_eMIOS_0_27_ADC0_ANS7_PD15 (L14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[63].R = 0x0001;
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[64]  eMIOS_0_16_CNRX_5_PE0 (F1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[64].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[65]  eMIOS_0_17_CNTX_5_PE1 (F4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[65].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[66]  eMIOS_0_18_SIN_1_PE2 (D7) */
    /* ----------------------------------------------------------- */
       SIU.PCR[66].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[67]  eMIOS_0_19_SOUT_1_PE3 (C7) */
    /* ----------------------------------------------------------- */
       SIU.PCR[67].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[68]  eMIOS_0_20_SCK_1_PE4 (D6) */
    /* ----------------------------------------------------------- */
       SIU.PCR[68].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[69]  eMIOS_0_21_PCS_1.0_ADC_MA2_PE5 (C6) */
    /* ----------------------------------------------------------- */
       SIU.PCR[69].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[70]  eMIOS_0_22_PCS_0.3_ADC_MA1_PE6 (B5) */
    /* ----------------------------------------------------------- */
       SIU.PCR[70].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[71]  eMIOS_0_23_PCS_0.2_ADC_MA0_PE7 (C4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[71].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[72]  CNTX_2_eMIOS_0_22_CNTX_3_PE8 (G2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[72].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[73]  eMIOS_0_23_CNRX_2_CNRX_3_PE9 (G1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[73].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[74]  TXD_3_PCS_1.3_PE10 (G3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[74].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[75]  RXD_3_PCS_1.4_PE11 (H2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[75].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[76]  SIN_2_eMIOS_1_19_PE12 (C14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[76].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[77]  SOUT_2_eMIOS_1_20_PE13 (D15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[77].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[78]  SCK_2_eMIOS_1_21_PE14 (C13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[78].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[79]  PCS_2.0_eMIOS_1_22_PE15 (A13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[79].R = 0x0001;
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[80]  eMIOS_0_10_PCS_1.3_ADC0_ANS8_PF0 (N10) */
    /* ----------------------------------------------------------- */
       SIU.PCR[80].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[81]  eMIOS_0_11_PCS_1.4_ADC0_ANS9_PF1 (P10) */
    /* ----------------------------------------------------------- */
       SIU.PCR[81].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[82]  eMIOS_0_12_PCS_2.0_ADC0_ANS10_PF2 (T10) */
    /* ----------------------------------------------------------- */
       SIU.PCR[82].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[83]  eMIOS_0_13_PCS_2.1_ADC0_ANS11_PF3 (R10) */
    /* ----------------------------------------------------------- */
       SIU.PCR[83].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[84]  eMIOS_0_14_PCS_2.2_ADC0_ANS12_PF4 (N11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[84].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[85]  eMIOS_0_22_PCS_2.3_ADC0_ANS13_PF5 (P11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[85].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[86]  eMIOS_0_23_ADC0_ANS14_PF6 (T11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[86].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[87]  ADC0_ANS15_PF7 (R11) */
    /* ----------------------------------------------------------- */
       SIU.PCR[87].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[88]  CNTX_3_PCS_0.4_CNTX_2_PF8 (P1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[88].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[89]  PCS_0.5_CNRX_2_CNRX_3_PF9 (N2) */
    /* ----------------------------------------------------------- */
       SIU.PCR[89].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[90]  PF10 (R3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[90].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[91]  PF11 (R4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[91].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[92]  eMIOS_1_25_PF12 (R1) */
    /* ----------------------------------------------------------- */
       SIU.PCR[92].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[93]  eMIOS_1_26_PF13 (T6) */
    /* ----------------------------------------------------------- */
       SIU.PCR[93].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[94]  CNTX_4_eMIOS_1_27_CNTX_1_PF14 (D14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[94].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[95]  CNRX_1_CNRX_4_PF15 (E15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[95].R = 0x0001;
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[96]  CNTX_5_eMIOS_1_23_PG0 (E14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[96].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[97]  eMIOS_1_24_CNRX_5_PG1 (E13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[97].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[98]  eMIOS_1_11_PG2 (E4) */
    /* ----------------------------------------------------------- */
       SIU.PCR[98].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[99]  eMIOS_1_12_PG3 (E3) */
    /* ----------------------------------------------------------- */
       SIU.PCR[99].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[100]  eMIOS_1_13_PG4 (E1) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[101]  eMIOS_1_14_PG5 (E2) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[102]  eMIOS_1_15_PG6 (M2) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[103]  eMIOS_1_16_PG7 (M1) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[104]  eMIOS_1_17_PCS_2.0_PG8 (L2) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[105]  eMIOS_1_18_SCK_2_PG9 (L1) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[106]  eMIOS_0_24_PG10 (D13) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[107]  eMIOS_0_25_PG11 (B12) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[108]  eMIOS_0_26_PG12 (K14) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[109]  eMIOS_0_27_PG13 (K16) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[110]  eMIOS_1_0_PG14 (B14) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[111]  eMIOS_1_1_PG15 (B13) */
    /* ----------------------------------------------------------- */
...
{
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[112]  eMIOS_1_2_SIN_1_PH0 (F13) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[113]  eMIOS_1_3_SOUT_1_PH1 (F14) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[114]  eMIOS_1_4_SCK_1_PH2 (F16) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[115]  eMIOS_1_5_PCS_1.0_PH3 (F15) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[116]  eMIOS_1_6_PH4 (A6) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[117]  eMIOS_1_7_PH5 (B6) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[118]  eMIOS_1_8_ADC_MA2_PH6 (D5) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[119]  eMIOS_1_9_PCS_2.3_ADC_MA1_PH7 (C5) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[120]  eMIOS_1_10_PCS_2.2_ADC_MA0_PH8 (A5) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[121]  TCK_PH9 (B8) */
    /* ----------------------------------------------------------- */
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[122]  TMS_PH10 (B9) */
    /* ----------------------------------------------------------- */
