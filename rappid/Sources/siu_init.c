...
void siu_portA_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[7]  eMIOS_0_7_PA7 (104) */
    /* ----------------------------------------------------------- */
       SIU.PCR[7].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[8]  eMIOS_0_8_PA8 (105) */
    /* ----------------------------------------------------------- */
       SIU.PCR[8].R = 0x0103;
...
void siu_portE_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[72]  eMIOS_0_22_PE8 (13) */
    /* ----------------------------------------------------------- */
       SIU.PCR[72].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[73]  eMIOS_0_23_PE9 (14) */
    /* ----------------------------------------------------------- */
       SIU.PCR[73].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[74]  PCS_1.3_PE10 (15) */
    /* ----------------------------------------------------------- */
       SIU.PCR[74].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[75]  PCS_1.4_PE11 (17) */
    /* ----------------------------------------------------------- */
       SIU.PCR[75].R = 0x0001;
...
void siu_portF_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[88]  PCS_0.4_PF8 (34) */
    /* ----------------------------------------------------------- */
       SIU.PCR[88].R = 0x0001;
    ...
    /* ----------------------------------------------------------- */
    /*      Pad Configuration Register PCR[89]  PCS_0.5_PF9 (33) */
    /* ----------------------------------------------------------- */
       SIU.PCR[89].R = 0x0001;
