...
uint32_t IntcIsrVectorTable[] = {
    ...
    (uint32_t)&interrupt_handler,    /* Vector - 105    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 106    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 107    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 108    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 109    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 110    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 111    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 112    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 113    Reserved */
    ...
    (uint32_t)&interrupt_handler,    /* Vector - 122    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 123    Reserved */
    (uint32_t)&interrupt_handler,    /* Vector - 124    Reserved */
