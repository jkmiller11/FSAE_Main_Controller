...
/*-----------------------------------------------------------*/
/*        channel Interrupt Mask Register 1 ADC_CIMR1)    */
/*-----------------------------------------------------------*/
    ADC.CIMR[1].R = 0x00000000;
...
/*-----------------------------------------------------------*/
/*        channel Interrupt Mask Register 2 ADC_CIMR2)    */
/*-----------------------------------------------------------*/
    ADC.CIMR[2].R = 0x00000000;
...
/*-----------------------------------------------------------*/
    ADC.NCMR[1].R = 0x00005500;
        ...
        /* ADC Channel 42 in Normal Mode : Enabled */
        /* ADC Channel 43 in Normal Mode : Disabled */
        /* ADC Channel 44 in Normal Mode : Enabled */
        /* ADC Channel 45 in Normal Mode : Disabled */
        /* ADC Channel 46 in Normal Mode : Enabled */
        /* ADC Channel 47 in Normal Mode : Disabled */


/*-----------------------------------------------------------*/
/* Normal Channel Conversion Mask Register 2(ADC_NCMR2)      */
/*-----------------------------------------------------------*/
...
/*-----------------------------------------------------------*/
/* Injected Channel Conversion Mask Register 0(ADC_JCMR0)    */
/*-----------------------------------------------------------*/
    ADC.JCMR[0].R = 0x00000000;
...
/*-----------------------------------------------------------*/
/* Injected Channel Conversion Mask Register 1(ADC_JCMR1)    */
/*-----------------------------------------------------------*/
    ADC.JCMR[1].R = 0x00000000;
...
/*-----------------------------------------------------------*/
/* Injected Channel Conversion Mask Register 2(ADC_JCMR2)    */
/*-----------------------------------------------------------*/
    ADC.JCMR[2].R = 0x00000000;
